        ...
        if (!initialized)
        {
            ...
            Prologue = new Encounter()
            {
                events = new Event()
                {
                    buttonText = "",
                    description = "",
                    image = Resources.Load<Sprite>("EventImages/Title/Title"),
                    event1 = new Event()
                    {
                        buttonText = "Start",
                        description = "In a lonely, desolate corner of the universe, there once lived the Goddess of the Dawn. She was beautiful,benevolent and endlessly kind, but she was also lonely.",
                        image = Resources.Load<Sprite>("EventImages/Prologue/Prologue1"),
                        event1 = new Event()
                        {
                            buttonText = "Continue",
                            description = "With nothing else to occupy her sad and sorry mind, she brought a world into being.",
                            image = Resources.Load<Sprite>("EventImages/Prologue/Prologue1"),
                            event1 = new Event()
                            {
                                buttonText = "Continue",
                                description = "From the earth of this world she wrenched up trees, and breathed grass into existence, and poured rivers into the spaces between. She piled rocks up into mountains, and when she was done, she went and lived within it. And for a while, everything was perfect and wonderful. ",
                                image = Resources.Load<Sprite>("EventImages/Prologue/Prologue1"),
                                event1 = new Event()
                                {
                                    buttonText = "Continue",
                                    description = "But then!",
                                    image = Resources.Load<Sprite>("EventImages/Prologue/Prologue2"),
                                    event1 = new Event()
                                    {
                                        buttonText = "Continue",
                                        description = "A meteor tore through the atmosphere, colliding with the world’s surface with an almighty CRASH!",
                                        image = Resources.Load<Sprite>("EventImages/Prologue/Prologue2"),
                                        event1 = new Event()
                                        {
                                            buttonText = "Continue",
                                            description = "Within the rubble of the meteor lay four humans, a Leader, a Hunter, a Shaman, and a Child. The Child awoke to a wild Dog licking his face. After him, one by one, they awoke, blinking in the sunlight, observing their new terrain.",
                                            image = Resources.Load<Sprite>("EventImages/Prologue/Prologue3"),
                                            event1 = new Event()
                                            {
                                                buttonText = "Continue",
                                                description = "But the humans did not come alone, for with them they brought the goddess’ arch nemesis, the God of Dusk!",
                                                image = Resources.Load<Sprite>("EventImages/Prologue/Prologue3"),
                                                event1 = new Event()
                                                {
                                                    buttonText = "Continue",
                                                    description = "As they watched darkness engulf the world behind them, the humans were filled with a horror they had never known before. They turned, desperately seeking solace in the world ahead of them, to spy Big Pointy Rock cutting into the blue sky on the horizon. Without a word exchanged, they knew what they must do: climb to the very top of Big Pointy Rock and escape the darkness!",
                                                    image = Resources.Load<Sprite>("EventImages/Prologue/Prologue3"),
                                                    event1 = new Event()
                                                    {
                                                        buttonText = "Continue",
                                                        description = "",
                                                        image = Resources.Load<Sprite>("EventImages/SplashScreen/LeaderSplash"),
                                                        event1 = new Event()
                                                        {
                                                            buttonText = "Continue",
                                                            description = "",
                                                            image = Resources.Load<Sprite>("EventImages/SplashScreen/HunterSplash"),
                                                            event1 = new Event()
                                                            {
                                                                buttonText = "Continue",
                                                                description = "",
                                                                image = Resources.Load<Sprite>("EventImages/SplashScreen/ChildSplash"),
                                                                event1 = new Event()
                                                                {
                                                                    buttonText = "Continue",
                                                                    description = "",
                                                                    image = Resources.Load<Sprite>("EventImages/SplashScreen/ShamanSplash"),
                                                                    event1 = new Event()
                                                                    {
                                                                        buttonText = "Continue",
                                                                        description = "",
                                                                        image = Resources.Load<Sprite>("EventImages/SplashScreen/DogSplash"),
                                                                        continueText = "Begin!"
                                                                    }
                                                                }
                                                            }
            ...
            Map = new Encounter()
            {
                events = new Event()
                {
                    ...
                    image = Resources.Load<Sprite>("EventImages/Map"),
            ...
            intervals.Add(new Encounter()
            {
                events = new Event()
                {
                    ...
                    image = Resources.Load<Sprite>("EventImages/Backgrounds/River2"),
                }
            });
            intervals.Add(new Encounter()
            {
                events = new Event()
                {
                    ...
                    image = Resources.Load<Sprite>("EventImages/Backgrounds/Forest2"),
                }
            });
            intervals.Add(new Encounter()
            {
                events = new Event()
                {
                    ...
                    image = Resources.Load<Sprite>("EventImages/Backgrounds/Plains1"),
                }
            });
            intervals.Add(new Encounter()
            {
                events = new Event()
                {
                    ...
                    image = Resources.Load<Sprite>("EventImages/Backgrounds/Forest1"),
                }
            });
            intervals.Add(new Encounter()
            {
                events = new Event()
                {
                    ...
                    image = Resources.Load<Sprite>("EventImages/Backgrounds/Plains2"),
                }
            });
            intervals.Add(new Encounter()
            {
                events = new Event()
                {
                    ...
                    image = Resources.Load<Sprite>("EventImages/Backgrounds/River1"),
                }
            });
            intervals.Add(new Encounter()
            {
            ...
            forestEncounters.Add(new Encounter()
            {
                events = new Event()
                {
                    ...
                    image = Resources.Load<Sprite>("EventImages/BeeHive/BeeHiveMain"),
            ...
            forestEncounters.Add(new Encounter()
            {
                events = new Event()
                {
                    ...
                    image = Resources.Load<Sprite>("EventImages/Vine/VineMain"),
                    statChange = new StatChange[] { StatChange.minusFood },
                    event1 = new Event()
                    {
            ...
            forestEncounters.Add(new Encounter()
            {
                events = new Event()
                {
                    ...
                    image = Resources.Load<Sprite>("EventImages/DireWolf/DirewolfMain"),
                    statChange = new StatChange[] { StatChange.minusFood },
                    event1 = new Event()
                    {
            ...
            forestEncounters.Add(new Encounter()
            {
                events = new Event()
                {
                    ...
                    image = Resources.Load<Sprite>("EventImages/Mushroom/MushroomMain"),
                    statChange = new StatChange[] { StatChange.minusFood },
                    event1 = new Event()
                    {
            ...
            forestEncounters.Add(new Encounter()
            {
                events = new Event()
                {
                    ...
                    image = Resources.Load<Sprite>("EventImages/Deer/DeerMain"),
                    statChange = new StatChange[] { StatChange.minusFood },
                    event1 = new Event()
                    {
            ...
            forestEncounters.Add(new Encounter()
            {
                events = new Event()
                {
                    ...
                    image = Resources.Load<Sprite>("EventImages/Bear/BearMain"),
                    statChange = new StatChange[] { StatChange.minusFood },
                    event1 = new Event()
                    {
            ...
            plainsEncounters.Add(new Encounter()
            {
                events = new Event()
                {
                    ...
                    image = Resources.Load<Sprite>("EventImages/DogRunAway/DogRunMain"),
                    statChange = new StatChange[] { StatChange.minusFood },
                    event1 = new Event()
                    {
            ...
            plainsEncounters.Add(new Encounter()
            {
                events = new Event()
                {
                    ...
                    image = Resources.Load<Sprite>("EventImages/Pigeon/PigeonMain"),
                    statChange = new StatChange[] { StatChange.minusFood },
                    event1 = new Event()
                    {
                        buttonText = "Attack!",
            ...
            plainsEncounters.Add(new Encounter()
            {
                events = new Event()
                {
                    ...
                    image = Resources.Load<Sprite>("EventImages/InjuredChild/InjuredChildMain"),
                    statChange = new StatChange[] { StatChange.minusFood },
                    event1 = new Event()
                    {
            ...
            plainsEncounters.Add(new Encounter()
            {
                events = new Event()
                {
                    ...
                    image = Resources.Load<Sprite>("EventImages/Fetch/FetchMain"),
                    statChange = new StatChange[] { StatChange.minusFood },
                    event1 = new Event()
                    {
            ...
            plainsEncounters.Add(new Encounter()
            {
                events = new Event()
                {
                    ...
                    image = Resources.Load<Sprite>("EventImages/Hill/HillMain"),
                    statChange = new StatChange[] { StatChange.minusFood },
                    event1 = new Event()
                    {
            ...
            plainsEncounters.Add(new Encounter()
            {
                events = new Event()
                {
                    ...
                    image = Resources.Load<Sprite>("EventImages/Horse/HorseMain"),
                    statChange = new StatChange[] { StatChange.minusFood },
                    event1 = new Event()
                    {
            ...
            plainsEncounters.Add(new Encounter()
            {
                events = new Event()
                {
                    ...
                    image = Resources.Load<Sprite>("EventImages/Flowers/FlowersMain"),
                    statChange = new StatChange[] { StatChange.minusFood },
                    event1 = new Event()
                    {
                        ...
                        event1 = new Event()
                        {
                            ...
                            image = Resources.Load<Sprite>("EventImages/Flowers/FlowersShaman"),
                            statChange = new StatChange[] { StatChange.addOptimism },
                        },
                        event2 = new Event()
                        {
                            ...
                            image = Resources.Load<Sprite>("EventImages/Flowers/FlowersChild"),
                            statChange = new StatChange[] { StatChange.addOptimism, StatChange.addOptimism },
                        },
                    },
                    event2 = new Event()
                    {
                        ...
                        event1 = new Event()
                        {
                            ...
                            image = Resources.Load<Sprite>("EventImages/Flowers/FlowersLeader"),
                            statChange = new StatChange[] { StatChange.addWisdom },
                        },
                        event2 = new Event()
                        {
                            ...
                            image = Resources.Load<Sprite>("EventImages/Flowers/FlowersHunter"),
                            statChange = new StatChange[] { StatChange.addOptimism, StatChange.addOptimism },
                        },
                        event3 = new Event()
                        {
                            ...
                            image = Resources.Load<Sprite>("EventImages/Flowers/FlowersDog"),
                            statChange = new StatChange[] { StatChange.addFood, StatChange.addWisdom },
                        },
                    }
                }
            ...
            plainsEncounters.Add(new Encounter()
            {
                events = new Event()
                {
                    ...
                    event2 = new Event()
                    {
                        buttonText = "Kill the cow",
                        description = "Kill the cow",
                        image = Resources.Load<Sprite>("EventImages/Backgrounds/Plains2"),
                        event1 = new Event()
                        {
                            buttonText = "Hunter",
            ...
            riverEncounters.Add(new Encounter()
            {
                events = new Event()
                {
                    ...
                    image = Resources.Load<Sprite>("EventImages/RiverCross/CrossMain"),
                    statChange = new StatChange[] { StatChange.minusFood },
                    event1 = new Event()
                    {
            ...
            riverEncounters.Add(new Encounter()
            {
                events = new Event()
                {
                    ...
                    image = Resources.Load<Sprite>("EventImages/Ducks/DucksMain"),
                    statChange = new StatChange[] { StatChange.minusFood },
                    event1 = new Event()
                    {
            ...
            riverEncounters.Add(new Encounter()
            {
                events = new Event()
                {
                    ...
                    image = Resources.Load<Sprite>("EventImages/ShinyObject/ShinyObjectMain"),
                    statChange = new StatChange[] { StatChange.minusFood },
                    event1 = new Event()
                    {
            ...
            riverEncounters.Add(new Encounter()
            {
                events = new Event()
                {
                    ...
                    image = Resources.Load<Sprite>("EventImages/Smell/SmellMain"),
                    statChange = new StatChange[] { StatChange.minusFood },
                    event1 = new Event()
                    {
                        ...
                        event1 = new Event()
                        {
                            ...
                            image = Resources.Load<Sprite>("EventImages/Smell/SmellHunter"),
                            statChange = new StatChange[] { StatChange.addOptimism, StatChange.addOptimism }
                        },
                        event2 = new Event()
                        {
            ...
            riverEncounters.Add(new Encounter()
            {
                events = new Event()
                {
                    ...
                    image = Resources.Load<Sprite>("EventImages/Quicksand/QuicksandMain"),
                    statChange = new StatChange[] { StatChange.minusFood },
                    event1 = new Event()
                    {
            ...
            riverEncounters.Add(new Encounter()
            {
                events = new Event()
                {
                    ...
                    image = Resources.Load<Sprite>("EventImages/Frog/FrogMain"),
                    statChange = new StatChange[] { StatChange.minusFood },
                    event1 = new Event()
                    {
